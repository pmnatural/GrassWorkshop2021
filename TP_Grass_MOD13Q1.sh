...
# Create the STRDS (time series) for NDVI and QA and register their lists of images
...
# Create a mask for each date using flag's information
...
# Create a series of images smoothed taking into account the space-time context for the ndvi
#Temporal-space
